<script lang="ts">
    ...
    async function fetchSalesData() {
        ...
        const apiUrl = `http://localhost/Codeblitz/backend/modules/get.php?action=getSalesInformationByDate&date=${formattedDate}`;
      ...
      <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <table class="w-full text-left table-fixed border-collapse">
          ...
          <tbody class="bg-white">
            {#if noSalesData}
                <tr>
                    <td colspan="9" class="p-3 text-center">No transaction data found.</td>
                </tr>   
                    ...
                    <tr class="border-t border-gray-300 {i % 2 === 0 ? 'bg-blue-50' : ''}">
                        ...
                        <td class="p-2 text-left border-b">
                            <ul class="list-none pl-5">
                                {#if sale.items_ordered}
                                    {#each JSON.parse(sale.items_ordered.replace(/\\/g, '')) as item}
            ...
            {:else}
                <tr>
                    <td colspan="9" class="p-3 text-center">No transaction data available.</td>
                </tr>
            {/if}
          </tbody>
        </table>
